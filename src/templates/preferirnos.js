    ...
    <div class="preferirnos">
      <div class="preferirnos__content container ">
        ...
        <h3>
          ...
          nueva propuesta como una opción segura y confiable.
        </h3>
        <div class="preferirnos__cards">
          <div class="preferirnos__tab current-card expertiz">
            ...
            <h2>Expertiz</h2>
            <p>
              En VGE Ingeniería, convergen tres campos de la Ingeniería civil en
              búsqueda de innovar en la industria y proponer un nuevo estándar
              en el desarrollo de soluciones estructurales.
            </p>
          </div>
          <div class="preferirnos__tab eficiencia">
            ...
            <h2>Eficiencia</h2>
            <p>
              Estamos dedicados a la optimización de nuestros procesos, buscando
              ser un referente en cuanto a pulcritud de nuestro trabajo y la
              práctica inversión del tiempo.
            </p>
          </div>
          <div class="preferirnos__tab respaldo">
            ...
            <h2>Respaldo</h2>
            <p>
              Nos motiva ser un sello de calidad, y demostrar nuestro
              compromiso, es parte de nuestras mayores fortalezas.
            </p>
          </div>
        </div>
        <div class="preferirnos__nav hide-for-desktop">
          <button
            type="button"
            class="preferirnos__indicator current-indicator"
          ></button>
